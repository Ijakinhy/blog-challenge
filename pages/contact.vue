  ...
  <div class="text-gray-600 body-font">
    ...
    >
      <div class="md:w-1/3 w-full">
        <h1
          class="text-4xl text-gray-800 sm:text-4xl font-bold title-font mb-4"
        >
          Contact Me
        </h1>
        <p class="leading-relaxed text-xl text-gray-900">
          I'm here to assist you! If you have any questions or need assistance,
          please feel free to reach out to me.
          <br /><br />
          You can also email me at
          <a
            href="mailto:contact@example.com"
            class="font-semibold border-b-4 border-green-400"
